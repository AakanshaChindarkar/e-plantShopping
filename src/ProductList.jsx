...
import { useSelector, useDispatch  } from 'react-redux'; // For useSelector to access Redux store
        ...
        <div>
            ...
            <div className="tag">
               ...
               <a href="/" style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white'}}>AAJK Company</h3>
                    <i style={{color:'white'}}>Where Every Dream comes true!</i>
                    </div>
                    </a>
                </div>
            ...
            <div style={styleObjUl}>
                ...
                <div className="">
                <a href="#" onClick={handleCartClick} style={{ display: 'flex', alignItems: 'center' }}>
